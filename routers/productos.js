...
router.post("/",(req,res)=>{
    if(req.body.nombre !== undefined && req.body.descripcion !== undefined && req.body.codigo !== undefined && req.body.precio !== undefined && req.body.stock !== undefined && req.body.foto !== undefined){
        req.body.id = id;
        let agrego = req.body;
